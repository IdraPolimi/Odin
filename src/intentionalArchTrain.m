function [inputCat, relSig, onthoSig, contIcsTmp,icsTemp, ics, POI ] = intentionalArchTrain( i, args )
...
structIM1 = struct('learningRate', learningRate, 'relSigFromOtherLayer', relSigFromOtherLayer,...
    'maxClusters', maxClusters,'ics', ics, 'POI', POI, 'inputCat', inputCat, 'maxPoints', ...
    maxPoints,'phyloSig',phyloSig, 'relThr', relThr,'layer', layer, 'thresholdFixingOntho', ...

...
warning('off','all');
%CONFIG VARS
maxNumofIMG = 80; % per test 200 per provare il sistema 400
...
for i=1:maxNumofIMG
   ...
   [catOut2, relSig2, ~, ~,~, ics2, POI2] = intentionalArchCannyTrain(i, structIA2);
    ...
    structIM4 = struct ('layer', 2,'numIM', 4, 'inputCat', inputLayer(2,catOut1, catOut2, 0), 'relSigFromOtherLayer', max(relSig2*disc, relSig1*disc), ...
        'learningRate', learningRate, 'maxClusters', maxClusters, 'maxPoints', ...
...
for i=1:maxNumofIMG
   ...
   structIM5 = struct ('layer', 2,'numIM', 5, 'inputCat', catOut2, 'relSigFromOtherLayer', relSig2*disc,...
    ...
    structIM7 = struct ('layer', 3,'numIM', 7, 'inputCat', inputLayer(2,catOut3, catOut4, 0), 'relSigFromOtherLayer', max(relSig3*disc, relSig4*disc),...
        'learningRate', learningRate, 'maxClusters', maxClusters, 'maxPoints', ...
        maxPoints,'phyloSig',phyloSig, 'relThr', relThr,'maxNumofIMG', maxNumofIMG,  ...
    ...
    structIM8 = struct ('layer', 3,'numIM', 8, 'inputCat', inputLayer(3,catOut3, catOut4, catOut5), 'relSigFromOtherLayer', max(relSig3*disc,max(relSig4*disc,relSig5*disc)),...
        'learningRate', learningRate, 'maxClusters', maxClusters, 'maxPoints', ...
        maxPoints,'phyloSig',phyloSig, 'relThr', relThr,'maxNumofIMG', maxNumofIMG,  ...
    ...
    structIM9 = struct ('layer', 3,'numIM', 9, 'inputCat', inputLayer(2,catOut4, catOut5, 0), 'relSigFromOtherLayer', max(relSig4*disc,relSig5*disc),...
        'learningRate', learningRate, 'maxClusters', maxClusters, 'maxPoints', ...
        maxPoints,'phyloSig',phyloSig, 'relThr', relThr,'maxNumofIMG', maxNumofIMG,  ...
    ...
    structIM10 = struct ('layer', 3,'numIM', 10, 'inputCat', inputLayer(2,catOut3, catOut5, 0), 'relSigFromOtherLayer', max(relSig3*disc,relSig5*disc),...
        'learningRate', learningRate, 'maxClusters', maxClusters, 'maxPoints', ...
        maxPoints,'phyloSig',phyloSig, 'relThr', relThr,'maxNumofIMG', maxNumofIMG,  ...
...
%CONFIG VARS
maxNumofIMG = 22; % per test 200 per provare il sistema 400
learningRate = 0.1; %discount factor hebbian learning
maxClusters = 128;
maxPoints = 6001;
minPhylo = 0.55;
maxPhylo = 1;
pathImg = 'TrainingCrop/'; % per test test1/ per provare il sistema test/
strImg = 'img';
pathSavedDoc = 'IMSdoc';
disc = 1; %0.905 EX-TER-MI-NA-TE
%END CONFIG VARS
...
for pinco=1:12 %training 5 volte di fila

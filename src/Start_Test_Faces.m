...
%CONFIG VARS
warning('off','all')
maxNumofIMG =110; % 380 tutte le facce di test
...
for dalek=1:11
    ...
    if (dalek==1)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 01';
    elseif (dalek==2)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 02';
    elseif (dalek==3)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 03';
    elseif (dalek==4)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 04';
    elseif (dalek==5)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 05';
    elseif (dalek==6)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 06';
    elseif (dalek==7)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 07';
    elseif (dalek==8)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 08';
    elseif (dalek==9)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 09';
    elseif (dalek==10)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 10';
    elseif (dalek==11)
        pathSavedDoc = 'IMSdoc\FacceYaleCrop - 11';
    end
...
print2file(val, 'IMSdoc', 'resultExt', 'matrix');
print2file(OUTPUT, 'IMSdoc', 'resultBin', 'matrix');
str = datestr(clock);
